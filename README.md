...
> An Application Framework for AI Engineering (⭐ 8.8k)

#### [#6035](https://github.com/spring-projects/spring-ai/pull/6035) — Fix recursive tool input schema by hoisting `$defs` to root  ![status](https://img.shields.io/badge/status-open-yellow)

Fixes [#5888](https://github.com/spring-projects/spring-ai/issues/5888).
...
<sub>This page lists merged and active contributions only. For the full PR history, see my <a href="https://github.com/spring-projects/spring-ai/pulls?q=is%3Apr+author%3Ajewoodev">author search on spring-ai</a>.</sub>
